...
class ProgressBloc extends Bloc<ProgressEvent, ProgressState> {
  ...
  Future<void> _onLoad(LoadProgressEntries event, Emitter<ProgressState> emit) async {
  ...
  Future<void> _onAdd(AddProgressEntry event, Emitter<ProgressState> emit) async {
    try {
  ...
  Future<void> _onEdit(EditProgressEntry event, Emitter<ProgressState> emit) async {
    try {
  ...
  Future<void> _onDelete(DeleteProgressEntry event, Emitter<ProgressState> emit) async {
    try {
